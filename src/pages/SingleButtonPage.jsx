...
// @ts-ignore;
import { Wand2 } from 'lucide-react';export default function SingleButtonPage(props) {const [clickCount, setClickCount] = useState(0);const [isClicked, setIsClicked] = useState(false);
  const handleClick = () => {
